# Generated by Django 3.2 on 2025-10-12 06:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='文件/文件夹名', max_length=50, verbose_name='文件夹名称')),
                ...
                ('file_path', models.CharField(blank=True, max_length=256, null=True, verbose_name='文件路路径')),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.project', verbose_name='项目名')),
